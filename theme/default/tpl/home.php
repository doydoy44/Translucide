...
<section class="mw960p mod center mbl">
    ...
    <article class="pbm mtl mod">
        ...
        <div class="plm fl w40 animation slide-left"><a <?php href('lien-6') ?>><?php media('image-6', '470') ?></a>
        </div>
    ...
    <article class="ptm mod" style="border-top: solid 1px #eee;" <?php bg("bg", 'lazy') ?>>
        ...
        <div class="prl fr w40 animation slide-right"><a <?php href('lien-map') ?>><?php media('image-7', '470') ?></a>
        </div>
...
while ($res_event = $sel_event->fetch_assoc()) {
    ...
    ?>
                        ...
                        <div>
                            ...
                            <a href="<?= make_url($res_event['url']); ?>"><span
                                        class="bt bg-color"><?php _e("Lire") ?></span></a>
                        </div>
