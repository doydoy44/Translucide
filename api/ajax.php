    ...
    case "quick-view-user":// AFFICHAGE RAPIDE D'UN COMPTE UTILISATEUR
        ...
        <script>
          ...
          $(function () {
            ...
            $.ajax({
              url: "<?=$GLOBALS['path']?>api/ajax.php?mode=user&uid=<?=(int)$_REQUEST['uid']?>&callback=reload",
    ...
    case "profil":// AFFICHAGE DU FORMULAIRE UTILISATEUR
        ...
        <script>
          ...
          $(function () {
            ...
            $("#user .load input").keyup(function () {
              user_tosave();
            });
            $("#user .load select").change(function () {
              user_tosave();
            });
